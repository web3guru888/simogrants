...
> All scores are generated by **ASI1 Mini** (`asi1-mini`) with 4 stakeholder agents scoring 12 dimensions per project. See [ASI1_VERIFICATION_REPORT.md](ASI1_VERIFICATION_REPORT.md) for proof.
