...
The platform is seeded with **real ASI1-evaluated** grant rounds:

### Round 1 — Ethereum Core Infrastructure ($500K, funded)
| Rank | Project | ASI1 Score | SQF Allocation |
|------|---------|-----------|----------------|
| 1 | Lodestar | 68.75 | $101,224 |
| 2 | Ethers.js | 85.67 | $86,509 |
| 3 | Foundry | 82.58 | $83,389 |
| 4 | Remix IDE | 77.08 | $77,835 |
| 5 | EthereumJS | 75.00 | $75,734 |
| 6 | Hardhat | 74.58 | $75,310 |

### Round 2 — DeFi Security & Auditing ($250K, funded)
| Rank | Project | ASI1 Score | SQF Allocation |
|------|---------|-----------|----------------|
| 1 | Slither | 79.25 | $71,337 |
| 2 | OpenZeppelin | 81.50 | $50,397 |
| 3 | Echidna | 76.34 | $47,206 |
| 4 | Immunefi | 66.59 | $41,177 |
| 5 | Certora | 64.50 | $39,884 |

### Round 3 — Governance & Public Goods ($350K, accepting applications)
Snapshot, Gitcoin Passport, Protocol Guild, Tally, RetroPGF — awaiting evaluation.

> All scores are generated by **ASI1 Mini** (`asi1-mini`) with 4 stakeholder agents scoring 12 dimensions per project. See [ASI1 Verification Report](archived/reviews/ASI1_VERIFICATION_REPORT.md) for proof.
...
- **64/64 Live E2E Tests** — Custom Playwright suite testing all pages, API, mobile, accessibility
...
[GitHub](https://github.com/web3guru888/simogrants/tree/pl-genesis-hackathon) | [X (@SIMOGRANTS)](https://x.com/SIMOGRANTS)
