        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="https://github.com/web3guru888/simogrants/tree/pl-genesis-hackathon" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-xs text-[#6b6a6a] hover:text-amber-400 transition-colors">
