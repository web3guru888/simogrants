        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 sm:pt-32 sm:pb-40">
          <div className="max-w-3xl">
            ...
            <div className="animate-fade-up delay-400 flex items-center gap-4 mt-8">
              <a href="https://github.com/web3guru888/simogrants" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-[#6b6a6a] hover:text-amber-400 transition-colors">
